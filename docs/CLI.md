...
| **MCP** | Full v2025-11-25 — 1 smart MCP tool, 66 compatibility aliases (incl. 4 profile aliases, 3 price watch aliases, provider health, award sweet-spot scanning), 5 prompts, resources, structured content, progress notifications, resource subscriptions, tool description orchestration |
