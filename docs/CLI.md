...
trvl watch migrate                                    # Collapse duplicate watches, compact price history
...
| **MCP** | 2026-07-28, plus 2025-11-25 and 2025-03-26 clients unchanged — 1 smart MCP tool, 66 legacy-compatible capabilities (incl. 4 profile, 3 price-watch, provider-health, award sweet-spot capabilities), 7 prompts, resources, structured content, progress notifications, `subscriptions/listen` (2025 clients still use resource subscriptions), tool description orchestration |
