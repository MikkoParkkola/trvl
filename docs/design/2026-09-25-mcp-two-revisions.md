...
| S5c | rule 3, handshake ignored | `initialize` with handshake `2025-11-25` and `_meta` `2026-07-28`, no header | no error. `protocolVersion` is `2026-07-28`. `resources.subscribe` is false. `resultType` is `complete` | yes. Today `protocolVersion` follows the handshake and is `2025-11-25`, while `resultType` is still added because `_meta` is 2026 |
