...
- Default flight search (Google Flights, Kiwi, Skiplagged), with solo or opt-in AFKLM and low-cost-carrier integrations
- Criteria-first accommodation search plus hotel discovery (Google Hotels, Booking.com, Airbnb, Hostelworld, Trivago, HomeToGo) and verified room/detail flows for shortlisted candidates
- Ground transport (buses, trains, ferries — 22 providers)
